CoD.T10PerksListItem = InheritFrom( LUI.UIElement )
CoD.T10PerksListItem.new = function ( menu, controller )
	...
	self:setClass( CoD.T10PerksListItem )
	self.id = "T10PerksListItem"
