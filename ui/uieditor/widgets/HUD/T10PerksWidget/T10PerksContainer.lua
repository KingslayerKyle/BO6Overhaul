...
require( "ui.uieditor.widgets.HUD.T10PerksWidget.T10PerksListItem" )
...
CoD.ZMPerks = {
	...
	},
	{
		...
		image_buyable = "ximage_374291de1d39e5",
	...
	},
	{
		...
		image = "ui_icon_perks_zm_widowswine",
		image_buyable = "ui_icon_zm_purchasemenu_perk_widowswine",
	...
	},
	{
		...
		image = "ui_icon_perks_zm_electriccherry",
		image_buyable = "ui_icon_zm_purchasemenu_perk_electriccherry",
...
CoD.T10PerksContainer = InheritFrom( LUI.UIElement )
CoD.T10PerksContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.T10PerksContainer )
	self.id = "T10PerksContainer"
	self.soundSet = "default"
	self:setLeftRight( true, false, 0, 1280 )
	self:setTopBottom( true, false, 0, 720 )
	self.anyChildUsesUpdateState = true
	
	self.PerkList = LUI.UIList.new( menu, controller, 3, 0, nil, false, false, 0, 0, false, false )
	self.PerkList:makeFocusable()
	self.PerkList:setLeftRight( false, false, 0, 0 )
	self.PerkList:setTopBottom( false, true, 0, -12 )
	self.PerkList:setWidgetType( CoD.T10PerksListItem )
	self.PerkList:setHorizontalCount( 20 )
	self.PerkList:setScale( 0.67 )
